#!/usr/bin/env node
/**
 * Push Blueprint v3.60 and Roadmap v3.60 to Notion "Insight 360 System" page
 * Usage: node scripts/push-blueprint-roadmap-v360.js
 */
...
async function main() {
    ...
    // 2. Read files
    const blueprintPath = path.join(__dirname, '../documentation/blueprints/I360 Blueprint v3-60 2026-03-03.md');
    const roadmapPath = path.join(__dirname, '../documentation/Roadmap/I360-ROADMAP 2026-03-03.md');
    ...
    await pushAsToggle(
        'Blueprint v3.60 - Social Publishing UX, Platform Admin Access & LLM Registry Sync (Mar 3, 2026)',
        blueprintMd,
        'blue_background'
    );
    ...
    await pushAsToggle(
        'Roadmap v3.60 - Social Publishing UX, Platform Admin Access & LLM Registry Sync (Mar 3, 2026)',
        roadmapMd,
        'green_background'
    );

#!/usr/bin/env node
/**
 * Push Blueprint v3.32 and Roadmap v3.32 to Notion "Insight 360 System" page
 * Usage: node scripts/push-blueprint-roadmap-v332.js
 */
...
async function main() {
    ...
    // 2. Read files
    const blueprintPath = path.join(__dirname, '../documentation/blueprints/I360 Blueprint v3-32 2026-01-29.md');
    const roadmapPath = path.join(__dirname, '../documentation/Roadmap/I360-ROADMAP 2026-01-29-b.md');
    ...
    await pushAsToggle(
        'Blueprint v3.32 - Database Security Hardening (Jan 29, 2026)',
        blueprintMd,
        'blue_background'
    );
    ...
    await pushAsToggle(
        'Roadmap v3.32 - Database Security Hardening (Jan 29, 2026)',
        roadmapMd,
        'green_background'
    );
